...
export default class SignInMerchant extends React.Component{
        state = {
            phonenumber: '', 
            securitypin: '',
        }
        ...
        signIn = () => {
            ...
            fetch('http://192.168.100.136:3002/merchant/signin', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    merchant_phonenumber : phonenumber,
                    merchant_pin : securitypin
                })
            })
            ...
            .then(res => {
                if(res.status != 200){
                    ...
                    AsyncStorage.setItem('merchant_phonenumber', res.merchant_phonenumber)
                    AsyncStorage.getItem('token', (err, result) => {
                        this.props.navigation.navigate('HomeMerchant', {
                            token : result,
                            merchant_phonenumber : res.merchant_phonenumber,
                ...
                <View style={ styles.container }>
                    <ImageBackground source={bg} style={ styles.imgb }> 
                        <View style={{ marginStart: 35, marginTop: 24 }}>
                            <Text style={ styles.judul }>Welcome Merchant</Text>
                        ...
                        <View style={ styles.bottom }>
                            <View style={{alignItems:'center', marginTop: 0 }}>
                                <TouchableOpacity
                                    ...
                                    onPress={this.signIn.bind(this)}>
                                    <Text style={ styles.styleTextSignIn }>Sign In Merchant</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                        ...
                        <View style={{justifyContent: 'center', backgroundColor: '#fff', alignItems:'center', marginTop: 0, marginBottom: 0, flexDirection: 'row'}}>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => this.props.navigation.navigate("SignUpMerchant")} >
